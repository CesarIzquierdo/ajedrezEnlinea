...
class Board:
    ...
    def __init__(self, rows, cols):
        ...
        ''''en este codiggo se crea el tablero como una matris de de 8 por 8 en el que
        se van poniendo las piezas en las posiciones 0 a 7 y de 6 a 7 en las filas, correspondientes
        ''''
        ...
        self.p1Name = "Jugador 1"
        self.p2Name = "Jugador 2"

        self.turn = "w"
        #aqui se establece el tiempo que va a durar el juego, el cual se mide en segundos, que son 15 minutos
        self.time1 = 900
        self.time2 = 900
        ...
        # actualizar movimiento es pra que cuando un jugador selecione una pieza y esta se mueva entonces mande una instruccion de que se movio y cambie la pieza
        # en la matris 
    ...
    #esta es para que cuando la pieza se selaciones cambie para decir que esta seleccionado
    ...
    #este es para que cuando una pieza este en peligro ara hacer un asesinato la seleccione
    def get_danger_moves(self, color):
        ...
        return danger_moves
    #3 esto es para comprobar si la pieza se va amover, por lo que al seleccionar la casilla entonces se va amover
